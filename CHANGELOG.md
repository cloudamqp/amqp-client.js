...
- `AMQPError.code` - the AMQP reply code (403, 404, ...) when the broker closed the channel or connection, so callers can branch on the error instead of matching the message text
